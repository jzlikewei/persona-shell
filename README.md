...
其中 Claude/Codex 的默认启动参数都通过 provider 模板管理。Codex 后台任务默认启动参数为 `exec --json --skip-git-repo-check --dangerously-bypass-approvals-and-sandbox`，可通过 `agents.providers.codex.background_args` 覆盖。
